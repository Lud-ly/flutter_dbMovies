...
class MoviesProvider extends ChangeNotifier {
  //Es como un Observable. Si la data cambia le notifica a todos los widgets que esten
  ...
  */
  void getSuggestionsByQuery(String sechtTerm) {
    ...
    debouncer.onValue = (value) async {
      ...
      _suggestionStreamController.add(
          result); //añado un evento que el streambuilder estara escuchando cuando se lanze
    };
